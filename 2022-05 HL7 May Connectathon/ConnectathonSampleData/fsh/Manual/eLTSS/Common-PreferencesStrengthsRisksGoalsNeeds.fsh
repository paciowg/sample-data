...
Instance: P0522-eLTSS-preferenceICWP
...
Instance: P0522-eLTSS-strengthManageBills
InstanceOf: Observation
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Observation-eltss"
* status = #final
...
Instance: P0522-eLTSS-strengthWalkWithCane
InstanceOf: Observation
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Observation-eltss"
* status = #final
...
Instance: P0522-eLTSS-riskFalls
...
Instance: P0522-eLTSS-goalBalance
InstanceOf: Goal
Usage: #example
...
Instance: P0522-eLTSS-goalDanceSonWedding
InstanceOf: Goal
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Goal-eltss"
* lifecycleStatus = #accepted
...
Instance: P0522-eLTSS-goalDanceDaughterWedding
InstanceOf: Goal
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Goal-eltss"
* lifecycleStatus = #accepted
* description.text = "Dance at daughter's upcoming wedding"
* subject = Reference(Patient/P0522-patientBSJ1)

Instance: P0522-eLTSS-needTransportation
...
Instance: P0522-eLTSS-needDiabetesEducation
InstanceOf: Condition
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Condition-eltss"
* clinicalStatus = $condition-clinical#active
...
Instance: P0522-eLTSS-needDepressionTreatment
InstanceOf: Condition
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Condition-eltss"
* clinicalStatus = $condition-clinical#active
