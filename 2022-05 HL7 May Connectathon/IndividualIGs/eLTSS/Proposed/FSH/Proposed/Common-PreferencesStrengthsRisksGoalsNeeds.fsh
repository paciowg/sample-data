...
Instance: PMC-eLTSS-preferenceICWP
...
Instance: PMC-eLTSS-strengthManageBills
InstanceOf: Observation
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Observation-eltss"
* status = #final
...
Instance: PMC-eLTSS-strengthWalkWithCane
InstanceOf: Observation
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Observation-eltss"
* status = #final
...
Instance: PMC-eLTSS-goalBalance
InstanceOf: Goal
Usage: #example
...
Instance: PMC-eLTSS-goalDanceSonWedding
InstanceOf: Goal
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Goal-eltss"
* lifecycleStatus = #accepted
...
Instance: PMC-eLTSS-goalDanceDaughterWedding
InstanceOf: Goal
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Goal-eltss"
* lifecycleStatus = #accepted
...
Instance: PMC-eLTSS-needTransportation
...
Instance: PMC-eLTSS-needDiabetesEducation
InstanceOf: Condition
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Condition-eltss"
* clinicalStatus = $condition-clinical#active
...
Instance: PMC-eLTSS-needDepressionTreatment
InstanceOf: Condition
Usage: #example
* meta.profile = "http://hl7.org/fhir/us/eLTSS/StructureDefinition/Condition-eltss"
* clinicalStatus = $condition-clinical#active
